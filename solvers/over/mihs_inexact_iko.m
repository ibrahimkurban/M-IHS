function [x,xx,time,flopc,in_iter,params,flopd] = mihs_inexact_iko(A,b,lam,m,x1,tol,maxit,params)
%%
%
...
if(noparam || ~isfield(params, 'k0'))
    [k0, ~, f_tr, tr_time] = hutchinson_estimator_iko(SA, lam,2, params.subtol, params.submaxit);
    params.k0 = k0;
else
    k0      = params.k0;
    f_tr    = 0;
