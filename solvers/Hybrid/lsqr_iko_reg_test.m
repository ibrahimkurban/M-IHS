function [x, xx,par, B, V] = lsqr_iko_reg_test(A,b,x,iter)
...
%     fun     = @(lam)(norm(gamma(10^lam).*Utb(1:end-1))^2 + delta0)/(1 + sum(gamma(10^lam)))^2;
    fun     = @(lam)(norm(gamma(10^lam).*Utb(1:end-1))^2 + delta0)/(nd + gaa(10^lam))^2;
