...
%     
    ...
    [~,xx,~, flopc] = pd_mihs_v2_exact_iko(A,b,lam,[4*k0, 4*k0],x1,[TOL TOL],[MAXIT MAXIT2], params3);
    err(:,k)     = err_x0(xx);
    flop(:,k)    = flopc;
    ...
    [~,xx,~, flopc] = pd_mihs_v2_inexact_iko(A,b,lam,[4*k0, 4*k0],x1,[TOL TOL2],[MAXIT MAXIT2], params4);
    err(:,k)     = err_x0(xx);
    flop(:,k)    = flopc;
